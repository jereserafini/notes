...
const Note = ({id, title, content, active, handleDeleteNote}) => {
  return (
        <Card className='note mb-4 mx-auto' style={{ width: '18rem' }}>
            <Card.Body>
                ...
                <div>
                    <Button variant="dark me-1" /* onClick={(e) => del(e)} */><MdEdit/></Button>
                    <Button variant="dark mx-1" /* onClick={(e) => del(e)} */><MdArchive/></Button>
